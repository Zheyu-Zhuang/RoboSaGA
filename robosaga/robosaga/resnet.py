...
"""_summary_
Copy from torchvision.models.resnet, with inplace operations replaced with out-of-place operations.
including:
    out += identity --> out = out + identity,
    ReLU(inplace=True) --> ReLU(inplace=False).
This replacement avoids errors and warnings in backwards gradient computation.
"""
