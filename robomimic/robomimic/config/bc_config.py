...
class BCConfig(BaseConfig):
    ...
    def saliency_config(self):
        ...
        self.saliency.output_shape = None
        ...
        self.saliency.saliency_erase_threshold = None  # threshold for erasing saliency
        self.saliency.blend_alpha = None  # blending alpha for blending random overlay
        self.saliency.saliency_saga_cap = None  # the cap for saliency values in RoboSaGA
