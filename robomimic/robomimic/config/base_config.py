...
class BaseConfig(Config):
    ...
    def saliency_config(self):
        """
        This function populates the `config.saliency` attribute of the config, which
        has several settings related to the saliency map computation process. This
    ...
    def train_config(self):
        ...
        self.train.color_jitter = False # color jittering enabled/disabled
    ...
    def observation_config(self):
        ...
        self.observation.encoder.rgb.core_kwargs.pool_class = (
